...
import com.hiveelpay.shop.service.GoodsOrderService;
import com.hiveelpay.shop.util.Constant;
import com.hiveelpay.shop.util.OAuth2RequestParamHelper;
import com.hiveelpay.shop.util.vx.WxApi;
import com.hiveelpay.shop.util.vx.WxApiClient;
...
public class GoodsOrderController {
    ...
    private final static String QR_PAY_URL = "http://shop.hiveelpay.org/goods/qrPay.html";
    static final String AppID = "wx077cb62e341f8a5c";
    static final String AppSecret = "e663ea068f3e4f952f143de1432a35c2";
    private final static String GetOpenIdURL = "http://shop.hiveelpay.org/goods/getOpenId";
    private final static String GetOpenIdURL2 = "http://shop.hiveelpay.org/goods/getOpenId2";
    ...
    public String buy(@PathVariable("goodsId") String goodsId) {
        ...
        goodsOrder.setGoodsName("HIVEELPAY捐助商品G_0001");
        goodsOrder.setAmount(1l);
        goodsOrder.setUserId("hiveelpay_000001");
    ...
    public String pay(@PathVariable("goodsOrderId") String goodsOrderId) {
        ...
        String result = HiveelPayUtil.call4Post(url + reqData);
    ...
    GoodsOrder createGoodsOrder(String goodsId, Long amount) {
        ...
        goodsOrder.setGoodsId(goodsId);
        goodsOrder.setGoodsName("HIVEELPAY捐助商品G_0001");
        goodsOrder.setAmount(amount == null ? 0L : amount);
        goodsOrder.setUserId("hiveelpay_000001");
        goodsOrder.setStatus(Constant.GOODS_ORDER_STATUS_INIT);
        int result = goodsOrderService.addGoodsOrder(goodsOrder);
        _log.info("插入商品订单,返回:{}", result);
    ...
    void outResult(HttpServletResponse response, String content) {
        ...
        try {
            ...
            pw.print(content);
            _log.error("response hiveelpay complete.");
        } catch (IOException e) {
            _log.error(e, "response hiveelpay write exception.");
        }
    }
