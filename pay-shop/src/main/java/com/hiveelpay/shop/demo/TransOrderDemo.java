...
public class TransOrderDemo {
    ...
    static String transOrderTest() {
        ...
        paramMap.put("channelUser", "oIkQuwhPgPUgl-TvQ48_UUpZUwMs"); // 微信openId(丁志伟):oIkQuwhPgPUgl-TvQ48_UUpZUwMs, 支付宝(丁志伟):wilson@hiveel.com
