package com.hiveelpay.shop.demo;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.hiveelpay.common.util.HiveelPayUtil;
import com.hiveelpay.common.util.PayDigestUtil;

import java.util.Map;

/**
 * Created by wilson  on 16/5/5.
 */
public class PayOrderDemo {
    ...
    static final String baseUrl = "http://172.168.1.6:3020/api";
    //static final String notifyUrl = "http://www.baidu.com"; // 本地环境测试,可到ngrok.cc网站注册
    static final String notifyUrl = "http://localhost:8081/goods/payNotify";
