...
<head>
    ...
    <title>【HIVEELPAY】分布式开源聚合支付</title>
...
<footer class="footer">
    <div class="container">
        <p class="text-muted">&copy;2018 hiveelpay <script src="https://s13.cnzz.com/z_stat.php?id=1262480096&web_id=1262480096" language="JavaScript"></script></p>
    </div>
</footer>
...
<script>
    ...
    function makeCode () {
        ...
        $("#vAmt").text(vAmt+'元');
        var qrText = 'http://shop.hiveelpay.org/goods/qrPay.html?amount=' + (vAmt*100);
