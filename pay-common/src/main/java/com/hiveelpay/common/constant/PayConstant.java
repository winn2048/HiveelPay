package com.hiveelpay.common.constant;
...
public class PayConstant {
    ...
    public final static String PAY_ZERO_PAYMENT = "ZERO_AMOUNT";
    ...
    public final static String PAY_CHANNEL_H_SUBSCRIPTION = "H_SUBSCRIPTION";                // HIVEEL 订阅支付 支付 h_subscription
    public final static String PAY_CHANNEL_H_CHARGE_SUBSCRIPTION = "H_CHARGE_SUBSCRIPTION";                // HIVEEL 订阅支付 支付 h_subscription
    public final static String PAY_CHANNEL_H_ONCE = "H_ONCE";                // Hiveel 一次交易 支付


    public final static String CHANNEL_NAME_WX = "WX";                // 渠道名称:微信
    public final static String CHANNEL_NAME_ALIPAY = "ALIPAY";        // 渠道名称:支付宝
    public final static String CHANNEL_NAME_HIVEEL = "HIVEEL";        // 渠道名称:HIVEEL
    ...
    public static final String SUB_SUCCESS_WAITING_TRANS_ID = "SUB_SUCCESS_WAITING_TRANS_ID";
    ...
    public static class HiveelConstant {
        public final static String TRADE_TYPE_HIVEEL_SUBSCRIPTION = "H_SUBSCRIPTION";                                    // 订阅支付
    }
