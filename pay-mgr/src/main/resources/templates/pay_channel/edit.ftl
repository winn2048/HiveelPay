		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<select name="channelId" lay-verify="required">
					<option value=""></option>
                    <option value="H_SUBSCRIPTION" <#if (item.channelId!"") == "H_SUBSCRIPTION">selected="selected"</#if>>H_SUBSCRIPTION</option>
                    <option value="H_CHARGE_SUBSCRIPTION" <#if (item.channelId!"") == "H_CHARGE_SUBSCRIPTION">selected="selected"</#if>>H_CHARGE_SUBSCRIPTION</option>
                    <option value="H_ONCE" <#if (item.channelId!"") == "H_ONCE">selected="selected"</#if>>H_ONCE</option>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<select name="channelName" lay-verify="required">
					<option value=""></option>
					<option value="HIVEEL" <#if (item.channelName!"") == "HIVEEL">selected="selected"</#if>>HIVEEL</option>
