    ...
    public String queryPayOrder(@RequestBody JSONObject params) {
        ...
        try {
            ...
            if (!"success".equalsIgnoreCase(errorMessage)) {
                ...
                return HiveelPayUtil.makeRetFail(HiveelPayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, errorMessage, null, null));
            }
            ...
            if (payOrder == null) {
                return HiveelPayUtil.makeRetFail(HiveelPayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "支付订单不存在", null, null));
            }
            ...
            return HiveelPayUtil.makeRetData(map, payContext.getString("resKey"));
        } catch (Exception e) {
            _log.error(e, "");
